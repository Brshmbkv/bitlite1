  ...
  <div class="add-dialog">
    ...
    >
      <v-form @submit.prevent="addExercise">
        ...
        >
          <v-card-title>
            <span class="add-dialog__header-text mt-4 mb-4">Добавление задачи</span>
          </v-card-title>
          <v-card-text>
            <v-row>
              <v-col
          ...
          >
            <v-btn
              :ripple="false"
              :elevation="0"
              :disabled="!exerciseTitle || !exerciseContent || !exerciseType || !exerciseLevel || !exerciseOrder || loading"
              :loading="loading"
              color="#0BC4B8"
              type="submit"
